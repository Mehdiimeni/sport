                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link"
                                            data-operation="Acepted" data-tableset="remittance_form2"
                                        ...
                                        <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link"
                                            data-operation="Regect" data-tableset="remittance_form2"
                                            data-id="<?php echo $remittanceDetail['id']; ?>">
                                        ...
                                        <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link"
                                            data-operation="Pending" data-tableset="remittance_form2"
                                            data-id="<?php echo $remittanceDetail['id']; ?>">
                                        ...
                                        <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link"
                                            data-operation="Archive" data-tableset="remittance_form2"
                                            data-id="<?php echo $remittanceDetail['id']; ?>">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly
                                                value="<?php if ($remittanceAgent !== null) {echo $remittanceAgent['name'];} ?>">
...
?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance_form2?id=<?php echo ($_GET['id']); ?>" method="post">
                            ...
                            <div class="d-flex align-items-start mt-2">
                                ...
                                <div class="w-100 overflow-hidden">
                                    ...
                                    <a href="./remittance_form2?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-3">
                                    <form action="./remittance_form2?id=<?php echo ($_GET['id']); ?>" method="post"
                                        ...
                                        <input type="hidden" value="remittance_form2" id="section_part_name"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form2"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="schedule" value="remittance_form2"
                                        class="btn btn-primary">
                                        <?php echo _lang['assign']; ?>
                                    </button>
                                </div>
