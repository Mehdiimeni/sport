<?php
///template/financial/remittance_form4_details.php
?>
                ...
                <div class="col-xxl-8 col-lg-6">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="remittance_form4" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="remittance_form4" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="remittance_form4" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="remittance_form4" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
                            ...
                            <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?php echo getValue('name', $remittanceDetail); ?>"  >
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="mobile"><?php echo _lang['mobile']; ?> :</label>
                                                <input type="text" class="form-control" readonly value="<?php echo getValue('mobile', $remittanceDetail); ?>"  >
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" readonly rows="3"><?php echo getValue('description', $remittanceDetail); ?></textarea>
                                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance_form4?id=<?php echo ($_GET['id']); ?>"
                                method="post">
                            ...
                            <div class="d-flex">
                                            ...
                                            <div class="me-3"></div>
                                                ...
                                                <a href="./remittance_form4?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>" class="text-muted font-13 d-inline-block mt-2"><i
...
<?php } ?>
                ...
                <div class="card">
                        ...
                        <?php if ($rbac->checkPermissionOperationByName('attach')) { ?>
                            <form action="remittance_form4?id=<?php echo($_GET['id']);?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ps-0">
                                            <a href="./remittance_form4?id=<?php echo($_GET['id']);?>&file=<?php echo $fileInfo['downloadLink']; ?>"
                    ...
                    <div class="modal fade" id="AssignTo" tabindex="-1" aria-labelledby="AssignToLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <input type="hidden" value="remittance_form4" id="section_part_name" name="section_part_name">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form4" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
