<?php
///template/financial/remittance_operation3_details.php
?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="remittance_form3" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="remittance_form3" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="remittance_form3" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="remittance_form3" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
        ...
        <?php } ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance_form3?id=<?php echo ($_GET['id']); ?>"
                                method="post">
                            ...
                            <div class="d-flex">
                                            ...
                                            <div class="me-3"></div>
                                                ...
                                                <a href="./remittance_form3?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>" class="text-muted font-13 d-inline-block mt-2"><i
...
<?php } ?>
                ...
                <div class="card">
                        ...
                        <?php if ($rbac->checkPermissionOperationByName('attach')) { ?>
                            <form action="remittance_form3?id=<?php echo($_GET['id']);?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal fade" id="AssignTo" tabindex="-1" aria-labelledby="AssignToLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <input type="hidden" value="remittance_form3" id="section_part_name" name="section_part_name">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form3" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
 ...
 <div class="modal fade" id="Schedule" tabindex="-1" aria-labelledby="ScheduleLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo _lang['close']; ?></button>
                                    <button type="submit" name="schedule" value="remittance_form3" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
