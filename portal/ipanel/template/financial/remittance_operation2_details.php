<?php
///template/financial/remittance_operation2_details.php
?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="remittance_form2" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="remittance_form2" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="remittance_form2" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="remittance_form2" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?php if ($remittanceAgent !== null) {echo $remittanceAgent['name'];} ?>"  >
                    ...
                    <div class="modal fade" id="AssignTo" tabindex="-1" aria-labelledby="AssignToLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <input type="hidden" value="remittance_form2" id="section_part_name" name="section_part_name">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form2" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
 ...
 <div class="modal fade" id="Schedule" tabindex="-1" aria-labelledby="ScheduleLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo _lang['close']; ?></button>
                                    <button type="submit" name="schedule" value="remittance_form2" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
