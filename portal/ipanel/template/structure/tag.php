                                    ...
                                    <tbody>
                                        ...
                                        while ($tagsDetails = $tagsResult->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $tagsDetails['last_updated_date']; ?>
                                                </td>
                                                <td>
                                                <?php if ($rbac->checkPermissionOperationByName('delete')) { ?>
                                                    <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal" data-table="tags"
                                                        data-id="<?php echo $tagsDetails['id']; ?>">
                                                    ...
                                                    <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal"
                                                        data-bs-target="#editModal" data-table="tags"
                                                        data-id="<?php echo $tagsDetails['id']; ?>">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" class="form-control addField" name="table_set" id="tableSet"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="tag_name"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField" id="tag_description"
                                                            name="tag_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" class="form-control editField" name="table_set" id="table_set">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="tag_name"
                                                            name="tag_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tag_description" class="form-label"><?php echo (_lang['description']); ?>
                                                           </label>
                                                        <textarea class="form-control editField" id="tag_description"
                                                            name="tag_description" required></textarea>
                                                    </div>
