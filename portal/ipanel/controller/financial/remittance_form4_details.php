<?php
///controller/financial/remittance_form4_details.php
...
$remittanceDetail = $financial->getRemittanceF4ById($remittance_id)->fetch_assoc();
...
window.location.replace('remittance_form4?id='+$remittance_id); 
    </script>
HTML;
