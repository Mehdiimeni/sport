<?php
///controller/financial/remittance_form1_details.php
...
$remittance_id = $_GET['id'];

$part_name = 'remittance_form1';
$comment->part_name = $part_name;
$comment->part_id = $remittance_id;

$remittanceDetail = $financial->getRemittanceF1ById($remittance_id)->fetch_assoc();

$allSchedule = $financial->getSchedule('remittance_form1', $remittance_id);
...
window.location.replace('remittance_form1?id='+$remittance_id); 
...
HTML;
    ...
    HTML;
        ...
        if (isset($_POST['issue'])) {
            ...
            $PVNO = $_POST['PVNO'];
            $AgentDebt = $_POST['AgentDebt'];
            $FundAvailability = isset($_POST['FundAvailability']) && !empty($_POST['FundAvailability']) ? 1 : 0;
            $BeneficiaryTL = isset($_POST['BeneficiaryTL']) && !empty($_POST['BeneficiaryTL']) ? 1 : 0;
            ...
            $admin_id = $_SESSION['admin_id'];
                ...
                $whereCondition = "id = $remittance_id";
