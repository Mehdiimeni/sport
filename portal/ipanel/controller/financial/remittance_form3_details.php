<?php
///controller/financial/remittance_form3_details.php
...
$remittanceDetail = $financial->getRemittanceF3ById($remittance_id)->fetch_assoc();
$remittanceAgent = $financial->getRemittanceF4ById($remittanceDetail['agent_id'])->fetch_assoc();

$allSchedule = $financial->getSchedule('remittance_form3', $remittance_id);
...
window.location.replace('remittance_form3?id='+$remittance_id); 
    </script>
HTML;
