<?php
///template/user/tasks_details.php
?>
                            ...
                            <div class="card d-block">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="dropdown card-widgets">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <button type="button" id="mentionUser" class="dropdown-item" data-bs-toggle="modal"
                                                data-ticket-id="<?php echo $_GET['ticket_id']; ?>"
                                                data-bs-target="#mentionModal"><i class="mdi mdi-plus-circle-outline"></i>
                                    ...
                                    if ($ticketDetails['status'] == 'open') {
                                        ...
                                        <a class="btn btn-secondary" data-ticket-id="<?php echo $ticketDetails['id']; ?>"
                                            data-user-id="<?php echo $_SESSION["user_id"]; ?>" id="ticketForwardButton"
                                            data-bs-toggle="modal" data-bs-target="#ticketForwardModal" title="Forward to ticket">
                                            <?php echo (_lang['forward']); ?>
                                        </a>
                                    <?php } ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="replyForm" method="post" action="">
                                <div class="modal-body">
                                    ...
                                    <!--
                                    <div class="form-group">
                                        <select required class="select2 form-control select2-multiple"
                                            data-toggle="select2" multiple="multiple" name="tags[]"
