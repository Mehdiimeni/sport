                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><?php echo _lang['agent']; ?></li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="./remittance_form4?add=r" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i><?php echo _lang['new_agent']; ?></a>
                                            </div>
