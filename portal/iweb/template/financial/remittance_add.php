<?php
///template/financial/remittance_add.php
?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance?add=r" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            <label for="remittance_title" class="form-label">
                                                <?php echo _lang['title']; ?>
                                            </label>
                                            <input type="text" id="remittance_title" name="remittance_title"
                                                class="form-control" placeholder="<?php echo _lang['enter_title']; ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label for="remittance_description" class="form-label">
                                                <?php echo _lang['description']; ?>
                                            </label>
                                            <textarea class="form-control" id="remittance_description"
                                                name="remittance_description" rows="5"
