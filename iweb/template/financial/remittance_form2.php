<?php
///template/financial/remittance_form2.php
?>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><?php echo _lang['cheque']; ?></li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?php echo _lang['cheque']; ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="./remittance_form2?add=r" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i><?php echo _lang['new_cheque']; ?></a>
                                            </div>
    ...
    <tr>
        ...
        <td class="table-action">
            <a href="./remittance_form2?id=<?php echo $remittance['id']; ?>" class="action-icon"><i class="mdi mdi-eye"></i></a>
        </td>
    </tr>
<?php } ?>
