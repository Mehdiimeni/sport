                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-header py-4 text-center bg-primary">
                            <a href="#">
                                <span><img src="./itheme/panel/images/logo.png" alt="logo"></span>
                            </a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form role="form" method="POST" action="">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label"><?php echo (_lang['full_name']); ?></label>
                                    <input class="form-control" type="text" id="name" name="name" placeholder="<?php echo (_lang['full_name']); ?>"
                                        required>
                                </div>
                                ...
                                <div class="mb-3 mb-0 text-center">
                                    <button class="btn btn-primary" type="submit" name="sign_up"
                                        value="<?php echo (_lang['sign_up']); ?>">
                                        <?php echo (_lang['sign_up']); ?>
                                    </button>
                                </div>
