                ...
                <div class="col-xxl-8 col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./user_position?id=<?php echo ($_GET['id']); ?>" method="post">
                            ...
                            <div class="d-flex align-items-start mt-2">
                                ...
                                <div class="w-100 overflow-hidden">
                                    ...
                                    <a href="./user_position?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>"
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="position?id=<?php echo($_GET['id']);?>" method="post"
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ps-0">
                                            <a href="./user_position?id=<?php echo($_GET['id']);?>&file=<?php echo $fileInfo['downloadLink']; ?>"
