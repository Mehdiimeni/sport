                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div id="tooltip-container">
                                                    <img src="assets/images/users/avatar-9.jpg" alt="image"
                                                        ...
                                                        data-bs-placement="bottom" title="Assigned to Arya S" />
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div id="tooltip-container1">
                                                    <img src="assets/images/users/avatar-2.jpg" alt="image"
                                                        ...
                                                        data-bs-placement="bottom" title="Assigned to James B" />
                                                </div>
                                                <div>
                                                    <ul class="list-inline font-13 text-end">
                                                        <li class="list-inline-item">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div id="tooltip-container2">
                                                    <img src="assets/images/users/avatar-4.jpg" alt="image"
                                                        ...
                                                        data-bs-placement="bottom" title="Assigned to Kevin C" />
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div id="tooltip-container5">
                                                    <img src="assets/images/users/avatar-7.jpg" alt="image"
                                                        ...
                                                        data-bs-placement="bottom" title="Assigned to Edward S" />
                                                </div>
                                                <div>
                                                    <ul class="list-inline font-13 text-end mb-0">
                                                        <li class="list-inline-item">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div id="tooltip-container8">
                                                    <img src="assets/images/users/avatar-5.jpg" alt="image"
                                                        ...
                                                        data-bs-placement="bottom" title="Assigned to Gary H" />
                                                </div>
                                                <div>
                                                    <ul class="list-inline font-13 text-end mb-0">
                                                        <li class="list-inline-item">
                ...
                <div class="col-xxl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-success btn-sm ms-3">Add New</a>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            ...
                                            <div class="d-flex mt-2 p-1">
                                                <img src="assets/images/users/avatar-5.jpg" class="me-2 rounded-circle"
                                                    height="36" alt="Dominc B" />
                                                <div class="w-100">
                                                    <h5 class="mt-0 mb-0">
