<?php
///template/first/card_register.php
?>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo _lang['card_register']; ?></a></li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?php echo _lang['card_register']; ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
