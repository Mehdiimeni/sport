                                    ...
                                    <tbody>
                                        ...
                                        while ($usersDetails = $usersResult->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo ($user->getUnitNameById($usersDetails['unit_id'])['unit_name']); ?>
                                                </td>
                                                <td>
                                                    <?php echo ($structure->getCompanyById($user->getUnitNameById($usersDetails['unit_id'])['company_id'])['company_name']); ?>
                                                </td>
                                                <td>
                                                        ...
                                                        <select class="form-control addField" name="unit_id"
                                                            ...
                                                            while ($unitsDetails = $unitsResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($unitsDetails['id']); ?>">
                                                                    ...
                                                                    <?php echo ($structure->getCompanyById($user->getUnitNameById($unitsDetails['id'])['company_id'])['company_name']); ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
