                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link"
                                            data-operation="Acepted" data-tableset="user_achievement"
                                            data-id="<?php echo $achievementDetail['id']; ?>">
                                        ...
                                        <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link"
                                            data-operation="Regect" data-tableset="user_achievement"
                                            data-id="<?php echo $achievementDetail['id']; ?>">
                                        ...
                                        <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link"
                                            data-operation="Pending" data-tableset="user_achievement"
                                            data-id="<?php echo $achievementDetail['id']; ?>">
                                        ...
                                        <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link"
                                            data-operation="Archive" data-tableset="user_achievement"
                                            data-id="<?php echo $achievementDetail['id']; ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start mt-2">
                                ...
                                <div class="w-100 overflow-hidden">
                                    ...
                                    <a href="./achievement?achievement_id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>"
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="achievement?achievement_id=<?php echo($_GET['id']);?>" method="post"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-3">
                                    <form action="./achievement?achievement_id=<?php echo ($_GET['id']); ?>"
                                        method="post" enctype="multipart/form-data">

                                        <input type="hidden" value="achievement" id="section_part_name"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="achievement" class="btn btn-primary">
                                        <?php echo _lang['assign']; ?>
                                    </button>
                                </div>
                                </form>
