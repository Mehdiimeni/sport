                            ...
                            <div class="table-responsive">
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        $provinces_profilesResult = $structure->getOrganizationProvinces();
                                        while ($provinces_profilesDetails = $provinces_profilesResult->fetch_assoc()) {

                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $provinces_profilesDetails['provinces_name']; ?>
                                                </td>
                                               
                                                <td>
                                                    <?php echo $provinces_profilesDetails['last_updated_date']; ?>
                                                </td>
                                                <td>
                                                    <?php if ($rbac->checkPermissionOperationByName('delete')) { ?>
                                                    <a href="javascript:void(0);" class="action-icon delete-item"
                                                        data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                        data-table="organization_provinces"
                                                        data-id="<?php echo $provinces_profilesDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="provinces_name" class="form-label">
                                                            <?php echo (_lang['provinces_name']); ?>
                                                        </label>
                                                        <input type="text" class="form-control addField"
                                                            id="provinces_name" name="provinces_name" required>
