                            ...
                            <div class="table-responsive">
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        $operationsResult = $structure->getOperations();
                                        while ($operationsDetails = $operationsResult->fetch_assoc()) {

                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $operationsDetails['operation_name']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $operationsDetails['operation_description']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $operationsDetails['last_updated_date']; ?>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal" data-table="operations"
                                                        data-id="<?php echo $operationsDetails['id']; ?>">
                                                    ...
                                                    <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal"
                                                        data-bs-target="#editModal" data-table="operations"
                                                        data-id="<?php echo $operationsDetails['id']; ?>">
                                    ...
                                    <div class="modal-dialog" operation="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" class="form-control addField" name="table_set" id="table_set"
                                                            value="operations">
                                                    <div class="mb-3">
                                                        <label for="operation_name" class="form-label">
                                                            <?php echo (_lang['name']); ?>
                                                        </label>
                                                        <input type="text" class="form-control addField" id="operation_name"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField" id="operation_description"
                                                            name="operation_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" class="form-control editField" name="table_set" id="table_set">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="operation_name"
                                                            name="operation_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="operation_description" class="form-label"><?php echo (_lang['description']); ?>
                                                           </label>
                                                        <textarea class="form-control editField" id="operation_description"
                                                            name="operation_description" required></textarea>
                                                    </div>
