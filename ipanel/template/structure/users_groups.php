                                    ...
                                    <tbody>
                                        ...
                                        while ($userGroupsDetails = $userGroupsResult->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $userGroupsDetails['users_groups_caption']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userGroupsDetails['users_groups_description']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userGroupsDetails['last_updated_date']; ?>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0);" class="action-icon delete-item"
                                                        ...
                                                        data-id="<?php echo $userGroupsDetails['id']; ?>">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <input type="hidden" class="form-control addField" name="table_set"
                                                        id="tableSet" value="users_groups">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField"
                                                            id="users_groups_name" name="users_groups_name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField"
                                                            id="users_groups_caption" name="users_groups_caption" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField"
                                                            id="users_groups_description"
                                                            name="users_groups_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-light my-2"
                                                        data-bs-dismiss="modal">ادامه</button>
                                                </div>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
