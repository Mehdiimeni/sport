<?php
///template/financial/remittance_form1_details.php
?>
                ...
                <div class="col-xxl-8 col-lg-6">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <?php if ($rbac->checkPermissionOperationByName('acepted')) { ?>
                                                <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link"
                                                    data-operation="Acepted" data-tableset="remittance_form1"
                                            ...
                                            <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                                <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link"
                                                    data-operation="Regect" data-tableset="remittance_form1"
                                                    data-id="<?php echo $remittanceDetail['id']; ?>">
                                            ...
                                            <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                                <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link"
                                                    data-operation="Pending" data-tableset="remittance_form1"
                                                    data-id="<?php echo $remittanceDetail['id']; ?>">
                                            ...
                                            <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                                <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link"
                                                    data-operation="Archive" data-tableset="remittance_form1"
                                                    data-id="<?php echo $remittanceDetail['id']; ?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <label for="beneficiary">
                                                <?php echo _lang['beneficiary']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('Beneficiary', $remittanceDetail); ?>">

                                        </div>
                                        <div class="form-group">
                                            <label for="addressAndTel">
                                                <?php echo _lang['address_tel']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('AddressAndTel', $remittanceDetail); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('BankName', $remittanceDetail); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('BankAddress', $remittanceDetail); ?>">

                                        </div>
                                        <div class="form-group">
                                            <label for="swift">
                                                <?php echo _lang['swift']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('Swift', $remittanceDetail); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('IBAN', $remittanceDetail); ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="accountNo">
                                                <?php echo _lang['account_number']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('AccountNo', $remittanceDetail); ?>">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <label for="licenseActivity">
                                                <?php echo _lang['license_activity']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('LicenseActivity', $remittanceDetail); ?>">

                                        </div>
                                        <div class="form-group">
                                            <label for="cargoDescription">
                                                <?php echo _lang['cargo_description']; ?> :
                                            </label>
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo getValue('CargoDescription', $remittanceDetail); ?>">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                <label for="bankAddress">
                                                    <?php echo _lang['beneficiary_tl']; ?> :
                                                </label>
                                                <input type="text" class="form-control" readonly
                                                    value="<?php
                                                $BeneficiaryTLValue = getValue('BeneficiaryTL', $remittanceDetail);
                                                $displayValue = ($BeneficiaryTLValue == 1) ? _lang['yes'] : _lang['no'];
                                                echo $displayValue;
                                                ?>">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly
                                                    value="<?php echo getValue('CompanyName', $remittanceDetail); ?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance_form1?id=<?php echo ($_GET['id']); ?>" method="post">
                                ...
                                <div class="d-flex align-items-start mt-2">
                                    ...
                                    <div class="w-100 overflow-hidden">
                                        ...
                                        <?php if ($rbac->checkPermissionOperationByName('reply')) { ?>
                                            <a href="./remittance_form1?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-3">
                                    <form action="./remittance_form1?id=<?php echo ($_GET['id']); ?>" method="post"
                                        ...
                                        <input type="hidden" value="remittance_form1" id="section_part_name"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="schedule" value="remittance_form1"
                                        class="btn btn-primary">
                                        <?php echo _lang['assign']; ?>
                                    </button>
                                </div>
                                    ...
                                    <form action="./remittance_form1?id=<?php echo ($_GET['id']); ?>" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" class="form-control"
                                                id="datetime-datepicker" name="PaymentDate" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="BeneficiaryTL" class="form-label">
                                                <?php echo _lang['beneficiary_tl']; ?>
                                            </label>
