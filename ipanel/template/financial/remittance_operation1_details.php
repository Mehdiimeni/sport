<?php
///template/financial/remittance_operation1_details.php
?>
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="./remittance_form1">
                                        <?php echo (_lang['transfer']); ?>
                                    </a></li>
                                <li class="breadcrumb-item active">
                                    <?php echo _lang['transfer_details']; ?>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="remittance_form1" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="remittance_form1" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="remittance_form1" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="remittance_form1" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
   ...
   <div class="row">
    ...
    <thead>
        <tr>
            ...
            <th><?php echo _lang['transaction_number']; ?></th>
            <th><?php echo _lang['supply']; ?></th>
...
?>"><?php echo $schedule['date_time']; ?></span>
</td>
            <td><?php echo $schedule['transaction_number']; ?></td>
            <td><?php echo $schedule['supply']; ?></td>
            ...
            <?php if ($rbac->checkPermissionOperationByName('action')) { ?>
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <!-- item-->
                                                    <?php if ($rbac->checkPermissionOperationByName('acepted')) { ?>
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="schedule" data-id="<?php echo $schedule['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="schedule" data-id="<?php echo $schedule['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="schedule" data-id="<?php echo $schedule['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="schedule" data-id="<?php echo $schedule['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('done')) { ?>
                                    <a href="javascript:void(0);" id="Done" class="dropdown-item operation-link" data-operation="Done" data-tableset="schedule" data-id="<?php echo $schedule['id']; ?>"><?php echo _lang['done']; ?></a>
                                <?php } ?>
        ...
        <?php } ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance_form1?id=<?php echo ($_GET['id']); ?>"
                                method="post">
                            ...
                            <div class="d-flex">
                                            ...
                                            <div class="me-3"></div>
                                                ...
                                                <a href="./remittance_form1?id=<?php echo ($_GET['id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>" class="text-muted font-13 d-inline-block mt-2"><i
...
<?php } ?>
                ...
                <div class="card">
                        ...
                        <?php if ($rbac->checkPermissionOperationByName('attach')) { ?>
                            <form action="remittance_form1?id=<?php echo($_GET['id']);?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ps-0">
                                            <a href="./remittance_form1?id=<?php echo($_GET['id']);?>&file=<?php echo $fileInfo['downloadLink']; ?>"
...
<!-- AssignTo Modal -->
                    <div class="modal fade" id="AssignTo" tabindex="-1" aria-labelledby="AssignToLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <input type="hidden" value="remittance_form1" id="section_part_name" name="section_part_name">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance_form1" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
 ...
 <div class="modal fade" id="Schedule" tabindex="-1" aria-labelledby="ScheduleLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="ScheduleLabel"><?php echo _lang['schedule']; ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body p-3">
                                ...
                                <div class="mb-3">
                                        <label for="date_time" class="form-label"><?php echo _lang['date_time']; ?></label>
                                        <input type="text" id="datetime-datepicker" class="form-control" name="date_time" placeholder="Date and Time" required>
                                    </div>

                                <div class="mb-3">
                                        <label for="transaction_number" class="form-label"><?php echo _lang['transaction_number']; ?></label>
                                        <input class="form-control" id="transaction_number" name="transaction_number"  required>
                                    </div>
                                    
                                <div class="mb-3">
                                        <label for="supply" class="form-label"><?php echo _lang['supply']; ?></label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo _lang['close']; ?></button>
                                    <button type="submit" name="schedule" value="remittance_form1" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
