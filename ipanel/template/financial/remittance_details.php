<?php
///template/financial/remittance_details.php
?>
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">
                                    <?php echo _lang['document_details']; ?>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">
                ...
                <div class="col-xxl-8 col-lg-6">
                    ...
                    <div class="card d-block">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h3 class="mt-0">
                                    <?php echo $remittanceDetail['remittance_title']; ?>
                                </h3>
                                ...
                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a href="javascript:void(0);" id="Acepted" class="dropdown-item operation-link" data-operation="Acepted" data-tableset="remittance_data" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['acepted']; ?></a>
                                                    <?php } ?>
                                                   
                             
                                <?php if ($rbac->checkPermissionOperationByName('regect')) { ?>
                                    <a href="javascript:void(0);" id="Regect" class="dropdown-item operation-link" data-operation="Regect" data-tableset="remittance_data" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['regect']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('pending')) { ?>
                                    <a href="javascript:void(0);" id="Pending" class="dropdown-item operation-link" data-operation="Pending" data-tableset="remittance_data" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['pending']; ?></a>
                                <?php } ?>
                                <?php if ($rbac->checkPermissionOperationByName('archive')) { ?>
                                    <a href="javascript:void(0);" id="Archive" class="dropdown-item operation-link" data-operation="Archive" data-tableset="remittance_data" data-id="<?php echo $remittanceDetail['id']; ?>"><?php echo _lang['archive']; ?></a>
                                <?php } ?>
                            ...
                            <p class="text-muted mb-2">
                                <?php echo $remittanceDetail['remittance_description']; ?>
                            </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="./remittance?remittance_id=<?php echo ($_GET['remittance_id']); ?>"
                                method="post">
                            ...
                            <div class="d-flex">
                                            ...
                                            <div class="me-3"></div>
                                                ...
                                                <a href="./remittance?remittance_id=<?php echo ($_GET['remittance_id']); ?>&parent_id=<?php echo ($commentDetail['id']); ?>" class="text-muted font-13 d-inline-block mt-2"><i
...
<?php } ?>
                ...
                <div class="card">
                        ...
                        <?php if ($rbac->checkPermissionOperationByName('attach')) { ?>
                            <form action="remittance?remittance_id=<?php echo($_GET['remittance_id']);?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-1 shadow-none border">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ps-0">
                                            <a href="./remittance?remittance_id=<?php echo($_GET['remittance_id']);?>&file=<?php echo $fileInfo['downloadLink']; ?>"
                    ...
                    <div class="modal fade" id="AssignTo" tabindex="-1" aria-labelledby="AssignToLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <input type="hidden" value="remittance" id="section_part_name" name="section_part_name">
                                <input type="hidden" value="<?php echo ($_GET['remittance_id']); ?>F" id="section_element_id" name="section_element_id">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="forward" value="remittance" class="btn btn-primary"><?php echo _lang['assign']; ?></button>
                                </div>
                                </form>
                            </div>
                        </div>
