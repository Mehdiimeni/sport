...
$remittanceDetail = $financial->getRemittanceF2ById($remittance_id)->fetch_assoc();
$remittanceAgent = $financial->getRemittanceF4ById($remittanceDetail['agent_id'])->fetch_assoc();

$allSchedule = $financial->getSchedule('remittance_form2', $remittance_id);
...
window.location.replace('remittance_form2?id='+$remittance_id); 
    </script>
HTML;
